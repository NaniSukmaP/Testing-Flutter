            ...
            children: <Widget>[
              ...
              Container(
                child: Padding(
                  ...
                  child:
                      Icon(Icons.file_download, color: widget.alat.warnaDasar),
                ),
                margin: EdgeInsets.symmetric(horizontal: 20.0),
                width: MediaQuery.of(context).size.width * 0.8,
                decoration: BoxDecoration(
                  border: Border.all(width: 2.0, color: widget.alat.warnaDasar),
